...
const struct ISL_reg_bits_struct
{ //Stores one array for each register setting in the format {register address, bit addr of LSB of value, bit length of value
